...
class PgkylSession(_Session):
  ...
  def plot(self,
    ...
    Args:
      ...
      cval: (--cval) For 1D plots, comma-separated values mapping each curve onto the colormap (e.g. '1e-6,2e-6'). Requires --cmap; defaults to the frame number (or the dataset index when no frame numbers can be found) if omitted.
