...
| [`06_alpha_convergence.py`](scripts/06_alpha_convergence.py) | A four-panel algorithm-sensitivity figure from two analytic, symmetric 1-D p1 modal-serendipity datasets, with joined linear/log axes |
