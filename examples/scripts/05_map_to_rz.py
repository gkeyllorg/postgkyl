"""R-Z mapping through fluent, functional, and reusable APIs.

Run directly:
    MPLBACKEND=Agg PYTHONPATH=src python examples/scripts/05_map_to_rz.py
"""
...
# Geometry is inferred from the dataset's simulation prefix.
mapped = pg.map_to_rz(data, z_axis=0.0, phi_tor=0.0, nz_interp=2)
fig = mapped.plot(title="Electron density in the poloidal plane",
                  ...
                  fixaspect=True,
                  no_show=True)
fig.savefig(OUTPUT_DIR / "05_map_to_rz.png")
